            ...
            <AreaWrapper>
                <IntroWrapper>
                    ...
                    <TextWrapper>
                        ...
                        <StyledP>
                            Det finns alltid en anledning att baka. Här hittar
                            du mina egna recept för alla typer av
                            svårighetsgrader och varianter.
                        </StyledP>
                        <StyledP style={{ marginBottom: '0px' }}>
                            Jag är en självlärd hobbybakare som älskar att testa
                            mig fram med olika smakkombinationer. Jag hoppas
                            kunna inspirera dig med mina recept!
                        </StyledP>
            ...
            <MainArea>
                <InfoArea>
                    <HelloBakers>
                        ...
                        <HelloBakersP>
                            Vad kul att du har hittat hit! Jag heter Amelia och
                            jag är en hobbybakare från Umeå som brinner för
                            kreativitet. Jag vill att köket ska vara en plats
                            där nyfikenhet får verka fritt – en plats där man
                            kan bli på bra humör!
                        </HelloBakersP>
                        <HelloBakersP style={{ marginBottom: '30px' }}>
                            Jag bakar allt från de enklaste småkakorna till mer
                            avancerade tårtor och bakverk. På min hemsida vill
                            jag att det ska finnas något för alla
                        </HelloBakersP>
                        <Link
                            to={'/om-mig'}
                            style={{ justifySelf: 'center', margin: '0px' }}
                        >
                ...
                <UtbudWrapper>
                    <GridContainer>
                        ...
                        <TextWrapperSvg>
                            <H3>Bakning</H3>
                            <P>
                                Jag kan baka till barnkalaset, baby showern
                                eller bara till hemmakvällen
                            </P>
                        </TextWrapperSvg>
                    </GridContainer>
                    <GridContainer>
                        ...
                        <TextWrapperSvg>
                            <H3>Konferenser</H3>
                            <P>
                                Jag fixar företagsfika till er konferens, after
                                work eller andra trevligheter
                            </P>
                        </TextWrapperSvg>
                    </GridContainer>
                    <GridContainer>
                        ...
                        <TextWrapperSvg>
                            <H3>Leveranser</H3>
                            <P>
                                Gratis utkörning av bakverk och godis inom Umeå
                                kommun!
                            </P>
                        </TextWrapperSvg>
                    </GridContainer>
