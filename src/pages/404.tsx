...
const NotFoundPage = ({ data, location }) => {
  return (
    <Layout >
      ...
      <Breadcrumbs style={{ marginLeft: '20px' }} crumbs={[{name: 'hem', to: '/'}, { name: '404', to: '/404'}]} />
      <Container>
        <NotFoundHeader>404: Sidan kunde inte hittas</NotFoundHeader>
        <EmptyHeader>Oj, här var det tomt</EmptyHeader>
        <P>Länken kan ha gått sönder, sidan kan ha tagits bort eller flyttats till en ny plats. Besök gärna någon av våra andra sidor istället</P>
