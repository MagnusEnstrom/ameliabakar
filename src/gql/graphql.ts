...
export type ActionMonitorAction = ContentNode & DatabaseIdentifier & Node & NodeWithContentEditor & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
   ...
   */
  ancestors?: Maybe<ActionMonitorActionToActionMonitorActionConnection>;
   ...
   */
  parent?: Maybe<ActionMonitorActionToParentConnectionEdge>;
...
/** Connection between the ActionMonitorAction type and the ActionMonitorAction type */
export type ActionMonitorActionToActionMonitorActionConnection = ActionMonitorActionConnection & Connection & {
  __typename?: 'ActionMonitorActionToActionMonitorActionConnection';
  /** Edges for the ActionMonitorActionToActionMonitorActionConnection connection */
  edges: Array<ActionMonitorActionToActionMonitorActionConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<ActionMonitorAction>;
  /** Information about pagination in a connection. */
  pageInfo: ActionMonitorActionToActionMonitorActionConnectionPageInfo;
};

/** An edge in a connection */
export type ActionMonitorActionToActionMonitorActionConnectionEdge = ActionMonitorActionConnectionEdge & Edge & {
  __typename?: 'ActionMonitorActionToActionMonitorActionConnectionEdge';
  /**
...
export type ActionMonitorActionToActionMonitorActionConnectionPageInfo = ActionMonitorActionConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'ActionMonitorActionToActionMonitorActionConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the ActionMonitorAction type and the ActionMonitorAction type */
export type ActionMonitorActionToParentConnectionEdge = ActionMonitorActionConnectionEdge & Edge & OneToOneConnection & {
  __typename?: 'ActionMonitorActionToParentConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /**
...
/** The Bestallning type */
export type Bestallning = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithRevisions & NodeWithTemplate & Previewable & UniformResourceIdentifiable & {
  __typename?: 'Bestallning';
  /**
   * The ancestors of the content node.
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
  ancestors?: Maybe<BestallningToBestallningConnection>;
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of the databaseId field
   */
  bestallningId: Scalars['Int']['output'];
  /** Connection between the Bestallning type and the category type */
  categories?: Maybe<BestallningToCategoryConnection>;
  /** Connection between the ContentNode type and the ContentType type */
  contentType?: Maybe<ContentNodeToContentTypeConnectionEdge>;
  /** The name of the Content Type the node belongs to */
  contentTypeName: Scalars['String']['output'];
  ...
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']['output']>;
  /** Whether the bestallning object is password protected. */
  hasPassword?: Maybe<Scalars['Boolean']['output']>;
  /** The globally unique identifier of the bestallning object. */
  id: Scalars['ID']['output'];
  /** Whether the node is a Comment */
  isComment: Scalars['Boolean']['output'];
  /** Whether the node is a Content Node */
  ...
  /** The GMT modified time for a post. If a post was recently updated the modified field will change to match the corresponding time in GMT. */
  modifiedGmt?: Maybe<Scalars['String']['output']>;
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Beställning&quot; was set to Show in GraphQL. */
  orderAFC?: Maybe<Bestallning_Orderafc>;
  /**
   * The parent of the content node.
   * @deprecated This content type is not hierarchical and typically will not have a parent
   */
  parent?: Maybe<BestallningToParentConnectionEdge>;
  /** The password for the bestallning object. */
  password?: Maybe<Scalars['String']['output']>;
  /** Connection between the Bestallning type and the Bestallning type */
  preview?: Maybe<BestallningToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId?: Maybe<Scalars['Int']['output']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId?: Maybe<Scalars['ID']['output']>;
  ...
  /** Connection between the Bestallning type and the Bestallning type */
  revisions?: Maybe<BestallningToRevisionConnection>;
  /** The Yoast SEO data of the ContentNode */
  seo?: Maybe<PostTypeSeo>;
  /** The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table. */
  slug?: Maybe<Scalars['String']['output']>;
  /** The current status of the object */
  status?: Maybe<Scalars['String']['output']>;
  /** Connection between the Bestallning type and the tag type */
  tags?: Maybe<BestallningToTagConnection>;
  /** The template assigned to the node */
  template?: Maybe<ContentTemplate>;
  /** Connection between the Bestallning type and the TermNode type */
  terms?: Maybe<BestallningToTermNodeConnection>;
  /** The unique resource identifier path */
  uri?: Maybe<Scalars['String']['output']>;
};
...
/** The Bestallning type */
export type BestallningAncestorsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The Bestallning type */
export type BestallningCategoriesArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<BestallningToCategoryConnectionWhereArgs>;
};


/** The Bestallning type */
export type BestallningEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The Bestallning type */
export type BestallningEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The Bestallning type */
export type BestallningRevisionsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<BestallningToRevisionConnectionWhereArgs>;
};


/** The Bestallning type */
export type BestallningTagsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<BestallningToTagConnectionWhereArgs>;
};


/** The Bestallning type */
export type BestallningTermsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<BestallningToTermNodeConnectionWhereArgs>;
};

/** Set relationships between the Bestallning to categories */
export type BestallningCategoriesInput = {
  /** If true, this will append the category to existing related categories. If false, this will replace existing relationships. Default true. */
  append?: InputMaybe<Scalars['Boolean']['input']>;
  /** The input list of items to set. */
  nodes?: InputMaybe<Array<InputMaybe<BestallningCategoriesNodeInput>>>;
};

/** List of categories to connect the Bestallning to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export type BestallningCategoriesNodeInput = {
  /** The description of the category. This field is used to set a description of the category if a new one is created during the mutation. */
  description?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the category. If present, this will be used to connect to the Bestallning. If no existing category exists with this ID, no connection will be made. */
...
/** Connection to Bestallning Nodes */
export type BestallningConnection = {
  /** A list of edges (relational context) between RootQuery and connected Bestallning Nodes */
  edges: Array<BestallningConnectionEdge>;
  /** A list of connected Bestallning Nodes */
  nodes: Array<Bestallning>;
  /** Information about pagination in a connection. */
  pageInfo: BestallningConnectionPageInfo;
};

/** Edge between a Node and a connected Bestallning */
export type BestallningConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The connected Bestallning Node */
  node: Bestallning;
};

/** Page Info on the connected BestallningConnectionEdge */
export type BestallningConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Set relationships between the Bestallning to tags */
export type BestallningTagsInput = {
  /** If true, this will append the tag to existing related tags. If false, this will replace existing relationships. Default true. */
  append?: InputMaybe<Scalars['Boolean']['input']>;
  /** The input list of items to set. */
  nodes?: InputMaybe<Array<InputMaybe<BestallningTagsNodeInput>>>;
};

/** List of tags to connect the Bestallning to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export type BestallningTagsNodeInput = {
  /** The description of the tag. This field is used to set a description of the tag if a new one is created during the mutation. */
  description?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the tag. If present, this will be used to connect to the Bestallning. If no existing tag exists with this ID, no connection will be made. */
  id?: InputMaybe<Scalars['ID']['input']>;
...
/** Connection between the Bestallning type and the Bestallning type */
export type BestallningToBestallningConnection = BestallningConnection & Connection & {
  __typename?: 'BestallningToBestallningConnection';
  /** Edges for the BestallningToBestallningConnection connection */
  edges: Array<BestallningToBestallningConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Bestallning>;
  /** Information about pagination in a connection. */
  pageInfo: BestallningToBestallningConnectionPageInfo;
};

/** An edge in a connection */
export type BestallningToBestallningConnectionEdge = BestallningConnectionEdge & Edge & {
  __typename?: 'BestallningToBestallningConnectionEdge';
  /**
   * A cursor for use in pagination
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
...
/** Page Info on the &quot;BestallningToBestallningConnection&quot; */
export type BestallningToBestallningConnectionPageInfo = BestallningConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'BestallningToBestallningConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the Bestallning type and the category type */
export type BestallningToCategoryConnection = CategoryConnection & Connection & {
  __typename?: 'BestallningToCategoryConnection';
  /** Edges for the BestallningToCategoryConnection connection */
  edges: Array<BestallningToCategoryConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Category>;
  /** Information about pagination in a connection. */
  pageInfo: BestallningToCategoryConnectionPageInfo;
};

/** An edge in a connection */
export type BestallningToCategoryConnectionEdge = CategoryConnectionEdge & Edge & {
  __typename?: 'BestallningToCategoryConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
...
/** Page Info on the &quot;BestallningToCategoryConnection&quot; */
export type BestallningToCategoryConnectionPageInfo = CategoryConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'BestallningToCategoryConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the BestallningToCategoryConnection connection */
export type BestallningToCategoryConnectionWhereArgs = {
...
/** Connection between the Bestallning type and the Bestallning type */
export type BestallningToParentConnectionEdge = BestallningConnectionEdge & Edge & OneToOneConnection & {
  __typename?: 'BestallningToParentConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /**
   * The node of the connection, without the edges
...
/** Connection between the Bestallning type and the Bestallning type */
export type BestallningToPreviewConnectionEdge = BestallningConnectionEdge & Edge & OneToOneConnection & {
  __typename?: 'BestallningToPreviewConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Bestallning;
...
/** Connection between the Bestallning type and the Bestallning type */
export type BestallningToRevisionConnection = BestallningConnection & Connection & {
  __typename?: 'BestallningToRevisionConnection';
  /** Edges for the BestallningToRevisionConnection connection */
  edges: Array<BestallningToRevisionConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Bestallning>;
  /** Information about pagination in a connection. */
  pageInfo: BestallningToRevisionConnectionPageInfo;
};

/** An edge in a connection */
export type BestallningToRevisionConnectionEdge = BestallningConnectionEdge & Edge & {
  __typename?: 'BestallningToRevisionConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Bestallning;
...
/** Page Info on the &quot;BestallningToRevisionConnection&quot; */
export type BestallningToRevisionConnectionPageInfo = BestallningConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'BestallningToRevisionConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the BestallningToRevisionConnection connection */
export type BestallningToRevisionConnectionWhereArgs = {
  /** Category ID */
...
/** Connection between the Bestallning type and the tag type */
export type BestallningToTagConnection = Connection & TagConnection & {
  __typename?: 'BestallningToTagConnection';
  /** Edges for the BestallningToTagConnection connection */
  edges: Array<BestallningToTagConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Tag>;
  /** Information about pagination in a connection. */
  pageInfo: BestallningToTagConnectionPageInfo;
};

/** An edge in a connection */
export type BestallningToTagConnectionEdge = Edge & TagConnectionEdge & {
  __typename?: 'BestallningToTagConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
...
/** Page Info on the &quot;BestallningToTagConnection&quot; */
export type BestallningToTagConnectionPageInfo = PageInfo & TagConnectionPageInfo & WpPageInfo & {
  __typename?: 'BestallningToTagConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the BestallningToTagConnection connection */
export type BestallningToTagConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']['input']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']['input']>;
...
/** Connection between the Bestallning type and the TermNode type */
export type BestallningToTermNodeConnection = Connection & TermNodeConnection & {
  __typename?: 'BestallningToTermNodeConnection';
  /** Edges for the BestallningToTermNodeConnection connection */
  edges: Array<BestallningToTermNodeConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<TermNode>;
  /** Information about pagination in a connection. */
  pageInfo: BestallningToTermNodeConnectionPageInfo;
};

/** An edge in a connection */
export type BestallningToTermNodeConnectionEdge = Edge & TermNodeConnectionEdge & {
  __typename?: 'BestallningToTermNodeConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: TermNode;
...
/** Page Info on the &quot;BestallningToTermNodeConnection&quot; */
export type BestallningToTermNodeConnectionPageInfo = PageInfo & TermNodeConnectionPageInfo & WpPageInfo & {
  __typename?: 'BestallningToTermNodeConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the BestallningToTermNodeConnection connection */
export type BestallningToTermNodeConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']['input']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']['input']>;
...
/** Field Group */
export type Bestallning_Orderafc = AcfFieldGroup & {
  __typename?: 'Bestallning_Orderafc';
  /** Kort beskrivning under titeln */
  description?: Maybe<Scalars['String']['output']>;
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
  /** Försök att ha minst 4st bilder så det inte ser konstigt ut på desktop */
  images?: Maybe<Array<Maybe<MediaItem>>>;
  pricelist?: Maybe<Array<Maybe<Bestallning_Orderafc_Pricelist>>>;
  /** Titel för order typen, kommer även användas till namn i prislista, tex Tårtor prislista */
  title?: Maybe<Scalars['String']['output']>;
};

/** Field Group */
export type Bestallning_Orderafc_Pricelist = AcfFieldGroup & {
  __typename?: 'Bestallning_Orderafc_pricelist';
  /** Kort beskrivning */
  description?: Maybe<Scalars['String']['output']>;
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
  ...
  /** Kostnaden i styck, det läggs till kr/st */
...
export type Category = DatabaseIdentifier & HierarchicalNode & HierarchicalTermNode & MenuItemLinkable & Node & TermNode & UniformResourceIdentifiable & {
  ...
  /** Connection between the Category type and the Bestallning type */
  bestallningar?: Maybe<CategoryToBestallningConnection>;
  /**
   * The id field matches the WP_Post-&gt;ID field.
  ...
  /** Connection between the Category type and the Recept type */
  recepts?: Maybe<CategoryToReceptConnection>;
...
/** The category type */
export type CategoryBestallningarArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<CategoryToBestallningConnectionWhereArgs>;
};
...
/** The category type */
export type CategoryReceptsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<CategoryToReceptConnectionWhereArgs>;
};
...
/** Connection between the Category type and the Bestallning type */
export type CategoryToBestallningConnection = BestallningConnection & Connection & {
  __typename?: 'CategoryToBestallningConnection';
  /** Edges for the CategoryToBestallningConnection connection */
  edges: Array<CategoryToBestallningConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Bestallning>;
  /** Information about pagination in a connection. */
  pageInfo: CategoryToBestallningConnectionPageInfo;
};

/** An edge in a connection */
export type CategoryToBestallningConnectionEdge = BestallningConnectionEdge & Edge & {
  __typename?: 'CategoryToBestallningConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Bestallning;
...
/** Page Info on the &quot;CategoryToBestallningConnection&quot; */
export type CategoryToBestallningConnectionPageInfo = BestallningConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'CategoryToBestallningConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the CategoryToBestallningConnection connection */
export type CategoryToBestallningConnectionWhereArgs = {
  /** Category ID */
  categoryId?: InputMaybe<Scalars['Int']['input']>;
  /** Array of category IDs, used to display objects from one category OR another */
  categoryIn?: InputMaybe<Array<InputMaybe<Scalars['ID']['input']>>>;
...
/** Connection between the Category type and the Recept type */
export type CategoryToReceptConnection = Connection & ReceptConnection & {
  __typename?: 'CategoryToReceptConnection';
  /** Edges for the CategoryToReceptConnection connection */
  edges: Array<CategoryToReceptConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Recept>;
  /** Information about pagination in a connection. */
  pageInfo: CategoryToReceptConnectionPageInfo;
};

/** An edge in a connection */
export type CategoryToReceptConnectionEdge = Edge & ReceptConnectionEdge & {
  __typename?: 'CategoryToReceptConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Recept;
...
/** Page Info on the &quot;CategoryToReceptConnection&quot; */
export type CategoryToReceptConnectionPageInfo = PageInfo & ReceptConnectionPageInfo & WpPageInfo & {
  __typename?: 'CategoryToReceptConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the CategoryToReceptConnection connection */
export type CategoryToReceptConnectionWhereArgs = {
  /** Category ID */
  categoryId?: InputMaybe<Scalars['Int']['input']>;
  /** Array of category IDs, used to display objects from one category OR another */
  categoryIn?: InputMaybe<Array<InputMaybe<Scalars['ID']['input']>>>;
...
/** Input for the createBestallning mutation. */
export type CreateBestallningInput = {
  /** Set connections between the Bestallning and categories */
  categories?: InputMaybe<BestallningCategoriesInput>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date?: InputMaybe<Scalars['String']['input']>;
  ...
  /** The status of the object */
  status?: InputMaybe<PostStatusEnum>;
  /** Set connections between the Bestallning and tags */
  tags?: InputMaybe<BestallningTagsInput>;
};

/** The payload for the createBestallning mutation. */
export type CreateBestallningPayload = {
  __typename?: 'CreateBestallningPayload';
  /** The Post object mutation type. */
  bestallning?: Maybe<Bestallning>;
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
};
...
/** Input for the createRecept mutation. */
export type CreateReceptInput = {
  /** Set connections between the Recept and categories */
  categories?: InputMaybe<ReceptCategoriesInput>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The content of the object */
  content?: InputMaybe<Scalars['String']['input']>;
  ...
  /** The status of the object */
  status?: InputMaybe<PostStatusEnum>;
  /** Set connections between the Recept and tags */
  tags?: InputMaybe<ReceptTagsInput>;
  /** The title of the object */
  title?: InputMaybe<Scalars['String']['input']>;
};

/** The payload for the createRecept mutation. */
export type CreateReceptPayload = {
  __typename?: 'CreateReceptPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  recept?: Maybe<Recept>;
...
/** Input for the deleteBestallning mutation. */
export type DeleteBestallningInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: InputMaybe<Scalars['Boolean']['input']>;
  /** The ID of the Bestallning to delete */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock?: InputMaybe<Scalars['Boolean']['input']>;
};

/** The payload for the deleteBestallning mutation. */
export type DeleteBestallningPayload = {
  __typename?: 'DeleteBestallningPayload';
  /** The object before it was deleted */
  bestallning?: Maybe<Bestallning>;
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
...
/** Input for the deleteRecept mutation. */
export type DeleteReceptInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: InputMaybe<Scalars['Boolean']['input']>;
  /** The ID of the Recept to delete */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock?: InputMaybe<Scalars['Boolean']['input']>;
};

/** The payload for the deleteRecept mutation. */
export type DeleteReceptPayload = {
  __typename?: 'DeleteReceptPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The ID of the deleted object */
  deletedId?: Maybe<Scalars['ID']['output']>;
...
export enum MediaItemSizeEnum {
  /** MediaItem with the full_hd size */
  FullHd = 'FULL_HD',
  /** MediaItem with the large size */
  Large = 'LARGE',
  /** MediaItem with the large_high size */
  LargeHigh = 'LARGE_HIGH',
...
export type MenuItemObjectUnion = Bestallning | Category | Page | Post | Recept | Tag | Tip;
...
export enum MenuLocationEnum {
  ...
  /** Put the menu in the footer-menu-additional location */
  FooterMenuAdditional = 'FOOTER_MENU_ADDITIONAL',
  ...
  /** Put the menu in the header-menu-additional location */
  HeaderMenuAdditional = 'HEADER_MENU_ADDITIONAL'
}
...
/** The Recept type */
export type Recept = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithRevisions & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  __typename?: 'Recept';
  /**
   * The ancestors of the content node.
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
  ancestors?: Maybe<ReceptToReceptConnection>;
  /** Connection between the Recept type and the category type */
  categories?: Maybe<ReceptToCategoryConnection>;
  /** The content of the post. */
  content?: Maybe<Scalars['String']['output']>;
  /** Connection between the ContentNode type and the ContentType type */
  contentType?: Maybe<ContentNodeToContentTypeConnectionEdge>;
  ...
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']['output']>;
  /** Whether the recept object is password protected. */
  hasPassword?: Maybe<Scalars['Boolean']['output']>;
  /** The globally unique identifier of the recept object. */
  id: Scalars['ID']['output'];
  /** Whether the node is a Comment */
  isComment: Scalars['Boolean']['output'];
  /** Whether the node is a Content Node */
   ...
   * @deprecated This content type is not hierarchical and typically will not have a parent
   */
  parent?: Maybe<ReceptToParentConnectionEdge>;
  /** The password for the recept object. */
  password?: Maybe<Scalars['String']['output']>;
  /** Connection between the Recept type and the Recept type */
  preview?: Maybe<ReceptToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId?: Maybe<Scalars['Int']['output']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId?: Maybe<Scalars['ID']['output']>;
   ...
   * @deprecated Deprecated in favor of the databaseId field
   */
  receptId: Scalars['Int']['output'];
  /** If the current node is a revision, this field exposes the node this is a revision of. Returns null if the node is not a revision of another node. */
  revisionOf?: Maybe<NodeWithRevisionsToContentNodeConnectionEdge>;
  /** Connection between the Recept type and the Recept type */
  revisions?: Maybe<ReceptToRevisionConnection>;
  /** The Yoast SEO data of the ContentNode */
  seo?: Maybe<PostTypeSeo>;
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Single-paket&quot; was set to Show in GraphQL. */
  singlePaketAfc?: Maybe<Recept_Singlepaketafc>;
  /** The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table. */
  slug?: Maybe<Scalars['String']['output']>;
  /** The current status of the object */
  status?: Maybe<Scalars['String']['output']>;
  /** Connection between the Recept type and the tag type */
  tags?: Maybe<ReceptToTagConnection>;
  /** The template assigned to the node */
  template?: Maybe<ContentTemplate>;
  /** Connection between the Recept type and the TermNode type */
  terms?: Maybe<ReceptToTermNodeConnection>;
  /** The title of the post. This is currently just the raw title. An amendment to support rendered title needs to be made. */
  title?: Maybe<Scalars['String']['output']>;
  /** The unique resource identifier path */
  uri?: Maybe<Scalars['String']['output']>;
...
/** The Recept type */
export type ReceptAncestorsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The Recept type */
export type ReceptCategoriesArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<ReceptToCategoryConnectionWhereArgs>;
};


/** The Recept type */
export type ReceptContentArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The Recept type */
export type ReceptEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The Recept type */
export type ReceptEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The Recept type */
export type ReceptRevisionsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<ReceptToRevisionConnectionWhereArgs>;
};


/** The Recept type */
export type ReceptTagsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<ReceptToTagConnectionWhereArgs>;
};


/** The Recept type */
export type ReceptTermsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<ReceptToTermNodeConnectionWhereArgs>;
};


/** The Recept type */
export type ReceptTitleArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};

/** Set relationships between the Recept to categories */
export type ReceptCategoriesInput = {
  /** If true, this will append the category to existing related categories. If false, this will replace existing relationships. Default true. */
  append?: InputMaybe<Scalars['Boolean']['input']>;
  /** The input list of items to set. */
  nodes?: InputMaybe<Array<InputMaybe<ReceptCategoriesNodeInput>>>;
};

/** List of categories to connect the Recept to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export type ReceptCategoriesNodeInput = {
  /** The description of the category. This field is used to set a description of the category if a new one is created during the mutation. */
  description?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the category. If present, this will be used to connect to the Recept. If no existing category exists with this ID, no connection will be made. */
  id?: InputMaybe<Scalars['ID']['input']>;
  /** The name of the category. This field is used to create a new term, if term creation is enabled in nested mutations, and if one does not already exist with the provided slug or ID or if a slug or ID is not provided. If no name is included and a term is created, the creation will fallback to the slug field. */
  name?: InputMaybe<Scalars['String']['input']>;
  /** The slug of the category. If no ID is present, this field will be used to make a connection. If no existing term exists with this slug, this field will be used as a fallback to the Name field when creating a new term to connect to, if term creation is enabled as a nested mutation. */
...
/** Connection to Recept Nodes */
export type ReceptConnection = {
  /** A list of edges (relational context) between RootQuery and connected Recept Nodes */
  edges: Array<ReceptConnectionEdge>;
  /** A list of connected Recept Nodes */
  nodes: Array<Recept>;
  /** Information about pagination in a connection. */
  pageInfo: ReceptConnectionPageInfo;
};

/** Edge between a Node and a connected Recept */
export type ReceptConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The connected Recept Node */
  node: Recept;
};

/** Page Info on the connected ReceptConnectionEdge */
export type ReceptConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Set relationships between the Recept to tags */
export type ReceptTagsInput = {
  /** If true, this will append the tag to existing related tags. If false, this will replace existing relationships. Default true. */
  append?: InputMaybe<Scalars['Boolean']['input']>;
  /** The input list of items to set. */
  nodes?: InputMaybe<Array<InputMaybe<ReceptTagsNodeInput>>>;
};

/** List of tags to connect the Recept to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export type ReceptTagsNodeInput = {
  /** The description of the tag. This field is used to set a description of the tag if a new one is created during the mutation. */
  description?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the tag. If present, this will be used to connect to the Recept. If no existing tag exists with this ID, no connection will be made. */
  id?: InputMaybe<Scalars['ID']['input']>;
  /** The name of the tag. This field is used to create a new term, if term creation is enabled in nested mutations, and if one does not already exist with the provided slug or ID or if a slug or ID is not provided. If no name is included and a term is created, the creation will fallback to the slug field. */
  name?: InputMaybe<Scalars['String']['input']>;
  /** The slug of the tag. If no ID is present, this field will be used to make a connection. If no existing term exists with this slug, this field will be used as a fallback to the Name field when creating a new term to connect to, if term creation is enabled as a nested mutation. */
...
/** Connection between the Recept type and the category type */
export type ReceptToCategoryConnection = CategoryConnection & Connection & {
  __typename?: 'ReceptToCategoryConnection';
  /** Edges for the ReceptToCategoryConnection connection */
  edges: Array<ReceptToCategoryConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Category>;
  /** Information about pagination in a connection. */
  pageInfo: ReceptToCategoryConnectionPageInfo;
};

/** An edge in a connection */
export type ReceptToCategoryConnectionEdge = CategoryConnectionEdge & Edge & {
  __typename?: 'ReceptToCategoryConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The Yoast SEO Primary category */
  isPrimary?: Maybe<Scalars['Boolean']['output']>;
...
/** Page Info on the &quot;ReceptToCategoryConnection&quot; */
export type ReceptToCategoryConnectionPageInfo = CategoryConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'ReceptToCategoryConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the ReceptToCategoryConnection connection */
export type ReceptToCategoryConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']['input']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']['input']>;
...
/** Connection between the Recept type and the Recept type */
export type ReceptToParentConnectionEdge = Edge & OneToOneConnection & ReceptConnectionEdge & {
  __typename?: 'ReceptToParentConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /**
   * The node of the connection, without the edges
...
/** Connection between the Recept type and the Recept type */
export type ReceptToPreviewConnectionEdge = Edge & OneToOneConnection & ReceptConnectionEdge & {
  __typename?: 'ReceptToPreviewConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Recept;
...
/** Connection between the Recept type and the Recept type */
export type ReceptToReceptConnection = Connection & ReceptConnection & {
  __typename?: 'ReceptToReceptConnection';
  /** Edges for the ReceptToReceptConnection connection */
  edges: Array<ReceptToReceptConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Recept>;
  /** Information about pagination in a connection. */
  pageInfo: ReceptToReceptConnectionPageInfo;
};

/** An edge in a connection */
export type ReceptToReceptConnectionEdge = Edge & ReceptConnectionEdge & {
  __typename?: 'ReceptToReceptConnectionEdge';
  /**
   * A cursor for use in pagination
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
...
/** Page Info on the &quot;ReceptToReceptConnection&quot; */
export type ReceptToReceptConnectionPageInfo = PageInfo & ReceptConnectionPageInfo & WpPageInfo & {
  __typename?: 'ReceptToReceptConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the Recept type and the Recept type */
export type ReceptToRevisionConnection = Connection & ReceptConnection & {
  __typename?: 'ReceptToRevisionConnection';
  /** Edges for the ReceptToRevisionConnection connection */
  edges: Array<ReceptToRevisionConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Recept>;
  /** Information about pagination in a connection. */
  pageInfo: ReceptToRevisionConnectionPageInfo;
};

/** An edge in a connection */
export type ReceptToRevisionConnectionEdge = Edge & ReceptConnectionEdge & {
  __typename?: 'ReceptToRevisionConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Recept;
...
/** Page Info on the &quot;ReceptToRevisionConnection&quot; */
export type ReceptToRevisionConnectionPageInfo = PageInfo & ReceptConnectionPageInfo & WpPageInfo & {
  __typename?: 'ReceptToRevisionConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the ReceptToRevisionConnection connection */
export type ReceptToRevisionConnectionWhereArgs = {
  /** Category ID */
  categoryId?: InputMaybe<Scalars['Int']['input']>;
  /** Array of category IDs, used to display objects from one category OR another */
  categoryIn?: InputMaybe<Array<InputMaybe<Scalars['ID']['input']>>>;
...
/** Connection between the Recept type and the tag type */
export type ReceptToTagConnection = Connection & TagConnection & {
  __typename?: 'ReceptToTagConnection';
  /** Edges for the ReceptToTagConnection connection */
  edges: Array<ReceptToTagConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Tag>;
  /** Information about pagination in a connection. */
  pageInfo: ReceptToTagConnectionPageInfo;
};

/** An edge in a connection */
export type ReceptToTagConnectionEdge = Edge & TagConnectionEdge & {
  __typename?: 'ReceptToTagConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The Yoast SEO Primary post_tag */
  isPrimary?: Maybe<Scalars['Boolean']['output']>;
...
/** Page Info on the &quot;ReceptToTagConnection&quot; */
export type ReceptToTagConnectionPageInfo = PageInfo & TagConnectionPageInfo & WpPageInfo & {
  __typename?: 'ReceptToTagConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the ReceptToTagConnection connection */
export type ReceptToTagConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']['input']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']['input']>;
...
/** Connection between the Recept type and the TermNode type */
export type ReceptToTermNodeConnection = Connection & TermNodeConnection & {
  __typename?: 'ReceptToTermNodeConnection';
  /** Edges for the ReceptToTermNodeConnection connection */
  edges: Array<ReceptToTermNodeConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<TermNode>;
  /** Information about pagination in a connection. */
  pageInfo: ReceptToTermNodeConnectionPageInfo;
};

/** An edge in a connection */
export type ReceptToTermNodeConnectionEdge = Edge & TermNodeConnectionEdge & {
  __typename?: 'ReceptToTermNodeConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: TermNode;
...
/** Page Info on the &quot;ReceptToTermNodeConnection&quot; */
export type ReceptToTermNodeConnectionPageInfo = PageInfo & TermNodeConnectionPageInfo & WpPageInfo & {
  __typename?: 'ReceptToTermNodeConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the ReceptToTermNodeConnection connection */
export type ReceptToTermNodeConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']['input']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']['input']>;
...
/** Field Group */
export type Recept_Singlepaketafc = AcfFieldGroup & {
  __typename?: 'Recept_Singlepaketafc';
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
  /** Horisontell bild för horisontellt läge (dator, surfplatta, mobil) för slidern på startsidan */
  horizontalImage?: Maybe<MediaItem>;
  images?: Maybe<Array<Maybe<MediaItem>>>;
  kortBeskrivning?: Maybe<Scalars['String']['output']>;
  saHarGorDu?: Maybe<Scalars['String']['output']>;
  svarighetsgrad?: Maybe<Scalars['String']['output']>;
  /** Hur många minuter / timmar ? */
  tid?: Maybe<Scalars['Float']['output']>;
  /** Minuter / timmar */
  tidFormat?: Maybe<Scalars['String']['output']>;
};
...
export type RootMutation = {
  ...
  /** The createBestallning mutation */
  createBestallning?: Maybe<CreateBestallningPayload>;
  ...
  /** The createRecept mutation */
  createRecept?: Maybe<CreateReceptPayload>;
  /** The createTag mutation */
  createTag?: Maybe<CreateTagPayload>;
  /** The createTip mutation */
  createTip?: Maybe<CreateTipPayload>;
  /** The createUser mutation */
  createUser?: Maybe<CreateUserPayload>;
  /** The deleteActionMonitorAction mutation */
  deleteActionMonitorAction?: Maybe<DeleteActionMonitorActionPayload>;
  /** The deleteBestallning mutation */
  deleteBestallning?: Maybe<DeleteBestallningPayload>;
  ...
  /** The deleteRecept mutation */
  deleteRecept?: Maybe<DeleteReceptPayload>;
  /** The deleteTag mutation */
  deleteTag?: Maybe<DeleteTagPayload>;
  /** The deleteTip mutation */
  ...
  /** The updateBestallning mutation */
  updateBestallning?: Maybe<UpdateBestallningPayload>;
  ...
  /** The updateRecept mutation */
  updateRecept?: Maybe<UpdateReceptPayload>;
  /** The updateSettings mutation */
  updateSettings?: Maybe<UpdateSettingsPayload>;
  /** The updateTag mutation */
  updateTag?: Maybe<UpdateTagPayload>;
  /** The updateTip mutation */
  updateTip?: Maybe<UpdateTipPayload>;
...
/** The root mutation */
export type RootMutationCreateBestallningArgs = {
  input: CreateBestallningInput;
};
...
/** The root mutation */
export type RootMutationCreateReceptArgs = {
  input: CreateReceptInput;
};
...
/** The root mutation */
export type RootMutationCreateTipArgs = {
...
/** The root mutation */
export type RootMutationDeleteBestallningArgs = {
  input: DeleteBestallningInput;
};
...
/** The root mutation */
export type RootMutationDeleteReceptArgs = {
  input: DeleteReceptInput;
};
...
/** The root mutation */
export type RootMutationDeleteTipArgs = {
...
/** The root mutation */
export type RootMutationUpdateBestallningArgs = {
  input: UpdateBestallningInput;
};
...
/** The root mutation */
export type RootMutationUpdateReceptArgs = {
  input: UpdateReceptInput;
};
...
/** The root mutation */
export type RootMutationUpdateTipArgs = {
...
export type RootQuery = {
  ...
  /** An object of the Bestallning Type.  */
  bestallning?: Maybe<Bestallning>;
  /**
   * A Bestallning object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
   */
  bestallningBy?: Maybe<Bestallning>;
  /** Connection between the RootQuery type and the Bestallning type */
  bestallningar?: Maybe<RootQueryToBestallningConnection>;
  ...
  /** An object of the Recept Type.  */
  recept?: Maybe<Recept>;
  /**
   * A Recept object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
   */
  receptBy?: Maybe<Recept>;
  /** Connection between the RootQuery type and the Recept type */
  recepts?: Maybe<RootQueryToReceptConnection>;
  ...
  tips?: Maybe<RootQueryToTipConnection>;
  /** Returns a user */
  user?: Maybe<User>;
  /** Returns a user role */
...
/** The root entry point into the Graph */
export type RootQueryBestallningArgs = {
  asPreview?: InputMaybe<Scalars['Boolean']['input']>;
  id: Scalars['ID']['input'];
  idType?: InputMaybe<BestallningIdType>;
};


/** The root entry point into the Graph */
export type RootQueryBestallningByArgs = {
  bestallningId?: InputMaybe<Scalars['Int']['input']>;
  id?: InputMaybe<Scalars['ID']['input']>;
  slug?: InputMaybe<Scalars['String']['input']>;
  uri?: InputMaybe<Scalars['String']['input']>;
};
...
/** The root entry point into the Graph */
export type RootQueryBestallningarArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<RootQueryToBestallningConnectionWhereArgs>;
};
...
/** The root entry point into the Graph */
export type RootQueryReceptArgs = {
  asPreview?: InputMaybe<Scalars['Boolean']['input']>;
  id: Scalars['ID']['input'];
  idType?: InputMaybe<ReceptIdType>;
};


/** The root entry point into the Graph */
export type RootQueryReceptByArgs = {
  id?: InputMaybe<Scalars['ID']['input']>;
  receptId?: InputMaybe<Scalars['Int']['input']>;
  slug?: InputMaybe<Scalars['String']['input']>;
  uri?: InputMaybe<Scalars['String']['input']>;
};
...
/** The root entry point into the Graph */
export type RootQueryReceptsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<RootQueryToReceptConnectionWhereArgs>;
};
...
/** The root entry point into the Graph */
export type RootQueryTipArgs = {
  asPreview?: InputMaybe<Scalars['Boolean']['input']>;
  id: Scalars['ID']['input'];
  idType?: InputMaybe<TipIdType>;
};


/** The root entry point into the Graph */
export type RootQueryTipByArgs = {
  id?: InputMaybe<Scalars['ID']['input']>;
  slug?: InputMaybe<Scalars['String']['input']>;
  tipId?: InputMaybe<Scalars['Int']['input']>;
  uri?: InputMaybe<Scalars['String']['input']>;
};


/** The root entry point into the Graph */
export type RootQueryTipsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<RootQueryToTipConnectionWhereArgs>;
};
...
/** Connection between the RootQuery type and the Bestallning type */
export type RootQueryToBestallningConnection = BestallningConnection & Connection & {
  __typename?: 'RootQueryToBestallningConnection';
  /** Edges for the RootQueryToBestallningConnection connection */
  edges: Array<RootQueryToBestallningConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Bestallning>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToBestallningConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToBestallningConnectionEdge = BestallningConnectionEdge & Edge & {
  __typename?: 'RootQueryToBestallningConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Bestallning;
...
/** Page Info on the &quot;RootQueryToBestallningConnection&quot; */
export type RootQueryToBestallningConnectionPageInfo = BestallningConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'RootQueryToBestallningConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the RootQueryToBestallningConnection connection */
export type RootQueryToBestallningConnectionWhereArgs = {
  /** Category ID */
  categoryId?: InputMaybe<Scalars['Int']['input']>;
  /** Array of category IDs, used to display objects from one category OR another */
  categoryIn?: InputMaybe<Array<InputMaybe<Scalars['ID']['input']>>>;
...
/** Connection between the RootQuery type and the Recept type */
export type RootQueryToReceptConnection = Connection & ReceptConnection & {
  __typename?: 'RootQueryToReceptConnection';
  /** Edges for the RootQueryToReceptConnection connection */
  edges: Array<RootQueryToReceptConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Recept>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToReceptConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToReceptConnectionEdge = Edge & ReceptConnectionEdge & {
  __typename?: 'RootQueryToReceptConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Recept;
...
/** Page Info on the &quot;RootQueryToReceptConnection&quot; */
export type RootQueryToReceptConnectionPageInfo = PageInfo & ReceptConnectionPageInfo & WpPageInfo & {
  __typename?: 'RootQueryToReceptConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the RootQueryToReceptConnection connection */
export type RootQueryToReceptConnectionWhereArgs = {
  /** Category ID */
  categoryId?: InputMaybe<Scalars['Int']['input']>;
  /** Array of category IDs, used to display objects from one category OR another */
  categoryIn?: InputMaybe<Array<InputMaybe<Scalars['ID']['input']>>>;
...
/** Connection between the RootQuery type and the Tip type */
export type RootQueryToTipConnection = Connection & TipConnection & {
...
/** An edge in a connection */
export type RootQueryToTipConnectionEdge = Edge & TipConnectionEdge & {
...
export type RootQueryToTipConnectionPageInfo = PageInfo & TipConnectionPageInfo & WpPageInfo & {
...
export type RootQueryToTipConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']['input']>;
...
export type SeoContentTypes = {
  ...
  bestallning?: Maybe<SeoContentType>;
  mediaItem?: Maybe<SeoContentType>;
  page?: Maybe<SeoContentType>;
  post?: Maybe<SeoContentType>;
  recept?: Maybe<SeoContentType>;
  tip?: Maybe<SeoContentType>;
};
...
export type Tag = DatabaseIdentifier & MenuItemLinkable & Node & TermNode & UniformResourceIdentifiable & {
  __typename?: 'Tag';
  /** Connection between the Tag type and the Bestallning type */
  bestallningar?: Maybe<TagToBestallningConnection>;
  ...
  /** Connection between the Tag type and the Recept type */
  recepts?: Maybe<TagToReceptConnection>;
...
/** The tag type */
export type TagBestallningarArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<TagToBestallningConnectionWhereArgs>;
};
...
/** The tag type */
export type TagReceptsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<TagToReceptConnectionWhereArgs>;
};
...
/** Connection between the Tag type and the Bestallning type */
export type TagToBestallningConnection = BestallningConnection & Connection & {
  __typename?: 'TagToBestallningConnection';
  /** Edges for the TagToBestallningConnection connection */
  edges: Array<TagToBestallningConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Bestallning>;
  /** Information about pagination in a connection. */
  pageInfo: TagToBestallningConnectionPageInfo;
};

/** An edge in a connection */
export type TagToBestallningConnectionEdge = BestallningConnectionEdge & Edge & {
  __typename?: 'TagToBestallningConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Bestallning;
...
/** Page Info on the &quot;TagToBestallningConnection&quot; */
export type TagToBestallningConnectionPageInfo = BestallningConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'TagToBestallningConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the TagToBestallningConnection connection */
export type TagToBestallningConnectionWhereArgs = {
  /** Category ID */
  categoryId?: InputMaybe<Scalars['Int']['input']>;
  /** Array of category IDs, used to display objects from one category OR another */
  categoryIn?: InputMaybe<Array<InputMaybe<Scalars['ID']['input']>>>;
...
/** Connection between the Tag type and the Recept type */
export type TagToReceptConnection = Connection & ReceptConnection & {
  __typename?: 'TagToReceptConnection';
  /** Edges for the TagToReceptConnection connection */
  edges: Array<TagToReceptConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Recept>;
  /** Information about pagination in a connection. */
  pageInfo: TagToReceptConnectionPageInfo;
};

/** An edge in a connection */
export type TagToReceptConnectionEdge = Edge & ReceptConnectionEdge & {
  __typename?: 'TagToReceptConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Recept;
...
/** Page Info on the &quot;TagToReceptConnection&quot; */
export type TagToReceptConnectionPageInfo = PageInfo & ReceptConnectionPageInfo & WpPageInfo & {
  __typename?: 'TagToReceptConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the TagToReceptConnection connection */
export type TagToReceptConnectionWhereArgs = {
  /** Category ID */
  categoryId?: InputMaybe<Scalars['Int']['input']>;
  /** Array of category IDs, used to display objects from one category OR another */
  categoryIn?: InputMaybe<Array<InputMaybe<Scalars['ID']['input']>>>;
...
/** The template assigned to the node */
export type Template_ContactPage = ContentTemplate & {
...
/** The template assigned to the node */
export type Template_FlexiblePage = ContentTemplate & {
  __typename?: 'Template_FlexiblePage';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']['output']>;
};
...
/** The Tip type */
export type Tip = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithRevisions & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  __typename?: 'Tip';
  /**
   * The ancestors of the content node.
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
  ancestors?: Maybe<TipToTipConnection>;
  /** The content of the post. */
  content?: Maybe<Scalars['String']['output']>;
  /** Connection between the ContentNode type and the ContentType type */
  contentType?: Maybe<ContentNodeToContentTypeConnectionEdge>;
  ...
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']['output']>;
  /** Whether the tips object is password protected. */
  hasPassword?: Maybe<Scalars['Boolean']['output']>;
  /** The globally unique identifier of the tips object. */
  id: Scalars['ID']['output'];
  /** Whether the node is a Comment */
  isComment: Scalars['Boolean']['output'];
  /** Whether the node is a Content Node */
   ...
   * @deprecated This content type is not hierarchical and typically will not have a parent
   */
  parent?: Maybe<TipToParentConnectionEdge>;
  /** The password for the tips object. */
  password?: Maybe<Scalars['String']['output']>;
  ...
  revisionOf?: Maybe<NodeWithRevisionsToContentNodeConnectionEdge>;
  /** Connection between the Tip type and the Tip type */
  revisions?: Maybe<TipToRevisionConnection>;
  /** The Yoast SEO data of the ContentNode */
  seo?: Maybe<PostTypeSeo>;
  /** The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table. */
  slug?: Maybe<Scalars['String']['output']>;
   ...
   * @deprecated Deprecated in favor of the databaseId field
   */
  tipId: Scalars['Int']['output'];
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Tips&quot; was set to Show in GraphQL. */
  tips?: Maybe<Tip_Tips>;
  /** The title of the post. This is currently just the raw title. An amendment to support rendered title needs to be made. */
  title?: Maybe<Scalars['String']['output']>;
  /** The unique resource identifier path */
...
/** The Tip type */
export type TipContentArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The Tip type */
export type TipEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The Tip type */
export type TipEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The Tip type */
export type TipRevisionsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<TipToRevisionConnectionWhereArgs>;
};
...
export type TipConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the Tip type and the Tip type */
export type TipToParentConnectionEdge = Edge & OneToOneConnection & TipConnectionEdge & {
  __typename?: 'TipToParentConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /**
   * The node of the connection, without the edges
...
/** Connection between the Tip type and the Tip type */
export type TipToPreviewConnectionEdge = Edge & OneToOneConnection & TipConnectionEdge & {
...
/** Connection between the Tip type and the Tip type */
export type TipToRevisionConnection = Connection & TipConnection & {
  __typename?: 'TipToRevisionConnection';
  /** Edges for the TipToRevisionConnection connection */
  edges: Array<TipToRevisionConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Tip>;
  /** Information about pagination in a connection. */
  pageInfo: TipToRevisionConnectionPageInfo;
};

/** An edge in a connection */
export type TipToRevisionConnectionEdge = Edge & TipConnectionEdge & {
  __typename?: 'TipToRevisionConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Tip;
...
/** Page Info on the &quot;TipToRevisionConnection&quot; */
export type TipToRevisionConnectionPageInfo = PageInfo & TipConnectionPageInfo & WpPageInfo & {
  __typename?: 'TipToRevisionConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the TipToRevisionConnection connection */
export type TipToRevisionConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']['input']>;
...
/** Connection between the Tip type and the Tip type */
export type TipToTipConnection = Connection & TipConnection & {
  __typename?: 'TipToTipConnection';
  /** Edges for the TipToTipConnection connection */
  edges: Array<TipToTipConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Tip>;
  /** Information about pagination in a connection. */
  pageInfo: TipToTipConnectionPageInfo;
};

/** An edge in a connection */
export type TipToTipConnectionEdge = Edge & TipConnectionEdge & {
  __typename?: 'TipToTipConnectionEdge';
  /**
   * A cursor for use in pagination
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
...
/** Page Info on the &quot;TipToTipConnection&quot; */
export type TipToTipConnectionPageInfo = PageInfo & TipConnectionPageInfo & WpPageInfo & {
  __typename?: 'TipToTipConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Field Group */
export type Tip_Tips = AcfFieldGroup & {
  __typename?: 'Tip_Tips';
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
  image?: Maybe<MediaItem>;
...
/** Input for the updateBestallning mutation. */
export type UpdateBestallningInput = {
  /** Set connections between the Bestallning and categories */
  categories?: InputMaybe<BestallningCategoriesInput>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the Bestallning object */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock?: InputMaybe<Scalars['Boolean']['input']>;
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
...
/** The payload for the updateBestallning mutation. */
export type UpdateBestallningPayload = {
  __typename?: 'UpdateBestallningPayload';
  /** The Post object mutation type. */
  bestallning?: Maybe<Bestallning>;
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
...
/** Input for the updateRecept mutation. */
export type UpdateReceptInput = {
  /** Set connections between the Recept and categories */
  categories?: InputMaybe<ReceptCategoriesInput>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
...
/** The payload for the updateRecept mutation. */
export type UpdateReceptPayload = {
  __typename?: 'UpdateReceptPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  recept?: Maybe<Recept>;
